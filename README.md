...
```
# $\color{red}{Concerns}$:  as PRSice eitimates p value threasholding in the target data set. Might be there is an issue of overfitting [Tutorial: a guide to performing polygenic risk score analyses]([https://www.internationalgenome.org/](https://www.nature.com/articles/s41596-020-0353-1)).
